-- List partitions
SELECT TableName = SCHEMA_NAME(o.schema_id) + '.' + OBJECT_NAME(i.object_id)
    ...
    , rv.value
    , first_page = CONVERT (VARCHAR(6), CONVERT (INT, SUBSTRING (au.first_page, 6, 1) + SUBSTRING (au.first_page, 5, 1))) 
